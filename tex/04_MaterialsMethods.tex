...
First, transition, emission, and state distribution matrices are simulated after the und
An overview of our model architecture is visualized in \autoref{fig:set_up}. 
